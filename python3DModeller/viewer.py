...
class Viewer(object):
    ...
    def init_interaction(self):
        ...
        self.interaction.register_callback('mode', self.move)
    ...
    def render(self):
        ...
        glClear(GL_COLOR_BUFFER_GIT | GL_DEPTH_BUFFER_BIT)
        ...
        # flush the bbbuffers so that the scene can be drawn 
        glFlush()
    ...
    def init_view(self):
        ...
        # load the projection matric. Always the same 
    ...
    def pick(self, x, y):
        ...
        start, irection = self.get_ray(x, y)
...
class Scene(object):
    ...
    def pick(self, start, direction, mat):
        ...
        mat is the inverse of the current odelView matrix for the scene 
        """
    ...
    def move_selected(self, start, direction, inv_modelview):
        ...
        # Find the current depth and lcoation of the selected node 
    ...
    def handle_mouse_move(self, x, screen_y):
        ...
        if self.pressed is not None:
            ...
            if self.pressed == GLUT_RIGHT_BUTTON and self.trackball is not None:
                ...
                self.translate(dx/600.0, dy/60.0, 0)
            else:
                pass 
            glutPostRedisplay() 
        self.mouse_loc = (x, y)
